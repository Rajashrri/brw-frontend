...
//for delete
  const handleyesno = async (id) => {
    try {
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/knowledgebase/delete/${id}`, {
        method: "DELETE",
      });
...
//for status
  const handleChangestatus = async (status,id) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/knowledgebase/update-status`, {
        method: "PATCH",
        headers: {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/knowledgebase/listdata`, {
        method: "GET",
      });
    ...
    },
    {
      ...
      cell: row => (
        <div className="module-action">
          ...
          <Link to={`/knowledge-base/edit/${row._id}`} className="btn btn-action" title="Edit Package">
            <FaEdit />
          </Link>
              ...
              <Row className="justify-content-between">
                ...
                <Col md={6}>
                  {/* <div className="dt-buttons btn-group">
                    <Link to={`/packages/add-package`} className="btn btn-outline-secondary" title="Add Knowledge Base">
                      Add Knowledge Base
                    </Link>
                  </div> */}
                </Col>
