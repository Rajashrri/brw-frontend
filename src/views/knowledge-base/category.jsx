...
const ModuleList = () => {
  ...
  const handleyesno = async (id) => {
    try {
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/knowledgebase/deletecategory/${id}`, {
        method: "DELETE",
      });
  ...
  const handleedit = async (id) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/knowledgebase/getcategoryByid/${id}`, {
        method: "GET",
      });
      const data = await response.json();
  ...
  const handleChange = async (status, id) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/knowledgebase/update-statuscategory`, {
        method: "PATCH",
        headers: {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/knowledgebase/getdatacategory`, {
        method: "GET",
      });
  ...
  const handleaddsubmit = async (e) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      if (!id) {
        try {
          const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/knowledgebase/addcategory`, {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
        ...
        try {
          const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/knowledgebase/updateCategory/${id}`, {
            method: "PATCH",
            headers: {
              "Content-Type": "application/json",
            },
  ...
  return (
    <Container className="list-module-preview">
      ...
      <Modal show={show1} onHide={handleClose1} className="other-icon-modal">
        ...
        <Modal.Body>
          <h3>{!itemIdToDelete ? 'Add' : 'Edit'} Knowledge Base Category</h3>
